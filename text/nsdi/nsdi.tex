...
\begin{figure*}
	...
	\subfloat[Single path transport protocol\label{fig:fig:maxflow-theory:tcp}]{%
		\includegraphics[width=0.4\textwidth]{figs/boxplot_maxflow_diff_accesslinks_5_20_50_tcp_segs_ecmp_0_0_boxplots.pdf}
	}
	\subfloat[Multiple path transport protocol\label{fig:fig:maxflow-theory:mptcp}]{%
		\includegraphics[width=0.4\textwidth]{figs/boxplot_maxflow_diff_accesslinks_5_20_50_mptcp_segs_ecmp_0_0_boxplots.pdf}
	}
