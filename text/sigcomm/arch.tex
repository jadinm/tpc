...
Then, they would all switch back to previous situation and continue flapping\todo{check term} between both paths.
...
\todo{Do we monitor the actual bandwidth of the path we are currently using?}
...
\lstinputlisting[language=C, caption={Reaction to congestion}, label={listing:congestion}]{code/congestion.c}



\todo{Listings for each portion of code}
